				...
				case '/': // Prefix: "/"
					...
					case '/': // Prefix: "/assign"
						...
						if len(elem) == 0 {
							...
							switch r.Method {
							case "POST":
								s.handleAssignTaskRequest([1]string{
									args[0],
								}, elemIsEscaped, w, r)
							default:
								s.notAllowed(w, r, "POST")
				...
				case '/': // Prefix: "/"
					...
					case '/': // Prefix: "/assign"
						...
						if len(elem) == 0 {
							...
							switch method {
							case "POST":
								r.name = AssignTaskOperation
								r.summary = "Assign users to a task"
								r.operationID = "assignTask"
								r.pathPattern = "/v1/tasks/{id}/assign"
								r.args = args
								r.count = 1
								return r, true
							default:
